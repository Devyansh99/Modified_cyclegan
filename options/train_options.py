...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        # OCR loss parameters
        parser.add_argument('--lambda_OCR', type=float, default=0.0, help='weight for OCR loss (text preservation). Use 0.001-0.01 for high-res images. Set to 0 to disable.')
